...
def test_flush_parquet_parts_writes_files(tmp_path):
    ...
    rows = [
        {"session_id": sid, "recv_ts_ns": 1000, "seq": 1, "unity_t": 0.01, "px": 0.1, "py": 0.2, "pz": 0.3, "qx": 0, "qy": 0, "qz": 0, "qw": 1.0},
        {"session_id": sid, "recv_ts_ns": 1000, "seq": 2, "unity_t": 0.02, "px": 0.2, "py": 0.2, "pz": 0.3, "qx": 0, "qy": 0, "qz": 0, "qw": 1.0},
    ]
