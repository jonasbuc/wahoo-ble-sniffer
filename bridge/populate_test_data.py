...
Usage: . .venv/bin/activate && python bridge/populate_test_data.py
"""
import time
import struct
import os
...
# ensure repo root is on sys.path so we can import bridge.collector_tail
_SCRIPT_DIR = os.path.dirname(__file__)
_REPO_ROOT = os.path.abspath(os.path.join(_SCRIPT_DIR, '..'))
if _REPO_ROOT not in sys.path:
    sys.path.insert(0, _REPO_ROOT)

from bridge import collector_tail as ct  # noqa: E402 (we modify sys.path above)
