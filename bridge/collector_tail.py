...
def main():
    ...
    # Resolve sensible defaults relative to the repo root (1 level up from this file:
    # bridge/collector_tail.py → repo root).
    _here = Path(__file__).resolve().parent
    _repo_root = _here.parent   # bridge → repo root
